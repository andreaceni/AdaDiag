...
from trainable import RNNAssemblyTrainable, LSTMTrainable, RNNTrainable

from search_space import (
    AdaDiag_search_space, SCR_search_space, lstm_search_space, rnn_search_space,
    AdaDiag_for_plot_Frequencies,
...
DATASET_CONFIGS = {
    "har2": {
        ...
        "search_spaces": {
            ...
            "rnn": rnn_search_space,
            "scr": SCR_search_space,
        },
    },
    "forda": {
    ...
    "fordb": {
        ...
        "search_spaces": {
            "rnnassembly": AdaDiag_search_space,
            #"rnnassembly": AdaDiag_for_plot_Frequencies, # <-- for plotting frequencies
            "lstm": lstm_search_space,
            "rnn": rnn_search_space,
            "scr": SCR_search_space,
        },
    ...
    "adiac": {
        ...
        "search_spaces": {
            "rnnassembly": AdaDiag_search_space,
            #"rnnassembly": AdaDiag_for_plot_withoutSkewSymmetry,
            "lstm": lstm_search_space,
            "rnn": rnn_search_space,
            "scr": SCR_search_space,
        },
...
def main():
    ...
    parser.add_argument("--model_type", nargs="+", default=["rnnassembly", "lstm", "rnn", "scr"], help="Model types to use for grid search")
    ...
    parser.add_argument("--results_dir", type=str, default="/storagenfs/a052721/AdaDiag/final_search/", help="Directory to save results")
