...
#python final_train_and_test.py --dataset smnist --gpus 3 --blocksize32 --block_config 2 --coupling_topology 5 --eul_step 0.1 --lr 0.01 --trials 3 --model_type scn --train_batch_size 512 --test_batch_size 512
...
python final_train_and_test.py --dataset smnist --gpus 2 --blocksize32 --block_config 2 --coupling_topology 20 --eul_step 0.1 --lr 0.001 --trials 3 --model_type scn --train_batch_size 128 --test_batch_size 128
