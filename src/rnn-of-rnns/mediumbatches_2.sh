...
python final_train_and_test.py --dataset ieeeppg --gpus 3 --blocksize8 --block_config 3 --gating --coupling_topology 5 --lr 0.01 --trials 3 --model_type adadiag --epochs 50 --train_batch_size 32 --test_batch_size 128 --decay_epochs 20 40
python final_train_and_test.py --dataset ieeeppg --gpus 3 --blocksize32 --block_config 2 --eul_step 0.1 --coupling_topology 5 --lr 0.01 --trials 3 --model_type scn --epochs 50 --train_batch_size 32 --test_batch_size 128 --decay_epochs 20 40
