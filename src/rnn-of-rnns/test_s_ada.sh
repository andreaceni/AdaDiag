...
python final_train_and_test.py --dataset smnist --gpus 2 --blocksize32 --block_config 3 --gating --coupling_topology 20 --lr 0.001 --trials 3 --model_type adadiag --train_batch_size 128 --test_batch_size 128
