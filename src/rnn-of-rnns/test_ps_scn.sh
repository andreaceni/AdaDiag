...
python final_train_and_test.py --dataset psmnist --gpus 0 --blocksize32 --block_config 2 --coupling_topology 500 --eul_step 0.1 --lr 0.001 --trials 3 --model_type scn --train_batch_size 128 --test_batch_size 128
